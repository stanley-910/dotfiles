return {
  {
    ...
    ---@type oil.SetupOpts
    opts = {
      -- Oil already sends workspace/willRenameFiles + workspace/didRenameFiles
      -- for file moves. Keep this native path instead of also calling
      -- snacks.rename from OilActionsPost, which duplicates rename notifications.
      lsp_file_methods = {
        enabled = true,
        timeout_ms = 1000,
